...
function detectSOSLocation() {
    ...
    const activatedLoc =
        document.getElementById('activatedLocation');
...
function startHold() {
    ...
    const fill =
        document.getElementById('holdFill');
...
function cancelHold() {
    ...
    if (fill)
        fill.style.strokeDashoffset = 452;
...
function cancelSOS() {
    ...
    if (responderList) {
        ...
        const items =
            responderList.querySelectorAll(
                '.responder-card-item'
            );
